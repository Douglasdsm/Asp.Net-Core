...
namespace Alura.ListaLeitura.App.Repositorio
{
	...
	{
		private static readonly string endereco = @"C:\Users\dougl\Documents\Curso Dados\Alura.ListaLeitura\Alura.ListaLeitura.App\Repositorio\livros.csv";
		...
		public void Incluir(Livro livro)
		{
			...
			using (var file = File.AppendText(endereco))
			{
